...
class Api::V1::WebsitesController < ApplicationController
  def index
    ...
    #   allProductsPriceDisplay << {product_name: product.product_name, amazon_price: lastAmzPrice.price_amt, walmart_price: lastWalmartPrice.price_amt, id: product.id}
      # binding.pry
    # end
    ...
    allProductsPriceDisplay << {product_name: 'Safety1st Gate', amazon_price: 20.98, walmart_price: 20.98, id: 1}
